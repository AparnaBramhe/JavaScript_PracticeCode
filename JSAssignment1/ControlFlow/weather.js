...
current temperature.
The program should use if...else or if...else if statements to 
determine the suggestion.  
Instructions: 
1. Create a new file named weather.js. Inside the file, declare a 
...
○ If temperature is below 10°C Print: stay indoors, it's too cold! 
Run the script using: node weather.js  
